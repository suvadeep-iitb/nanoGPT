...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        k = k.view(B, T, self.n_head, config.head_dim).transpose(1, 2) # (B, nh, T, hs)
        q = q.view(B, T, self.n_head, config.head_dim).transpose(1, 2) # (B, nh, T, hs)
        v = v.view(B, T, self.n_head, config.head_dim).transpose(1, 2) # (B, nh, T, hs)
